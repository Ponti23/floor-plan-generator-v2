...
export const RECOMMENDED_PRESENTATION_COPY: Readonly<PlanLabPresentationCopy> = Object.freeze({
  ...
  storage: {
    ...
    notices: {
      ...
      resultsOutdated: "The layouts from the previous session were generated by a different build, so they were discarded and need regenerating.",
      resetIncomplete: "Some saved data could not be removed from this browser. The workspace was reset, but a stored copy may still be present.",
