...
self-contained prompt. Terra@Max is reserved for complex execution and independent review.
...
2. Select the next bucket's executor: Luna@Max by default, Terra@Max only when its criteria apply.
